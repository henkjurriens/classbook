...
const routes = [
    {
        ...
        children: [
            {
                path: 'tab1',
                loadChildren: () => Promise.all(/*! import() | classmates-classmates-module */[__webpack_require__.e("common"), __webpack_require__.e("classmates-classmates-module")]).then(__webpack_require__.bind(null, /*! ../classmates/classmates.module */ "f1Bo")).then(m => m.Tab1PageModule)
            },
            {
                path: 'tab2',
